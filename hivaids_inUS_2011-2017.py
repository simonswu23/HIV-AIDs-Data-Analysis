...
def m_transmission(hiv_data):
    ...
    transmission = hiv_data[hiv_data['Category'] == 'Transmission Category: Male Adult or Adolescent']
...
def f_transmission(hiv_data):
    ...
    transmission = hiv_data[hiv_data['Category'] == 'Transmission Category: Female Adult or Adolescent']
    transmission = transmission.groupby('Year')['Count'].sum().reset_index()
